...
function default_1(lang, scriptRanges, scriptSetupRanges, htmlGen, compilerOptions, cssVars) {
    return {
        ...
        getEmbeddedFile(fileName, sfc, i) {
            ...
            const embedded = {
                file,
                sourceMap: new sourceMaps_1.EmbeddedFileSourceMap(codeGen.codeGen.getMappings()),
                teleport: new sourceMaps_1.Teleport(codeGen.teleports),
            };
            return embedded;
        },
    };
...
//# sourceMappingURL=vue-typescript-scripts%20copy.js.map