...
function default_1(ts, cssModuleClasses, cssScopedClasses, templateCodeGens, cssVars, scriptSetupRanges, scriptLang, compilerOptions, disableTemplateScript) {
    return {
        ...
        getEmbeddedFile(fileName, sfc, i) {
            ...
            if (i === 0 && !disableTemplateScript) {
                ...
                const sourceMap = new SourceMaps.SourceMapBase(tsxCodeGen.getMappings());
                const embedded = {
                ...
                const sourceMap = new sourceMaps_1.EmbeddedFileSourceMap(templateCodeGens.value.formatCodeGen.getMappings());
                return {
                ...
                const sourceMap = new sourceMaps_1.EmbeddedFileSourceMap(templateCodeGens.value.cssCodeGen.getMappings());
                return {
