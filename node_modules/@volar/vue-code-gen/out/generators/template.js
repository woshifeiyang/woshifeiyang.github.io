...
function generate(ts, sourceLang, templateAst, vueVersion, experimentalRuntimeMode, allowTypeNarrowingInEventExpressions, hasScriptSetup, cssScopedClasses = [], htmlToTemplate, searchTexts) {
    ...
    for (const tagName in tagOffsetsMap) {
        ...
        const var_rawComponent = (0, shared_1.capitalize)((0, shared_1.camelize)(tagName));
        ...
        const name2 = isIntrinsicElement(experimentalRuntimeMode, tagName) ? tagName : (0, shared_1.camelize)(tagName); // helloWorld
        const name3 = isIntrinsicElement(experimentalRuntimeMode, tagName) ? tagName : (0, shared_1.capitalize)(name2); // HelloWorld
        ...
        for (const prop of node.props) {
            if (prop.type === 7 /* CompilerDOM.NodeTypes.DIRECTIVE */
                ...
                const propName_2 = !isStatic ? propName_1
                    : (0, shared_1.hyphenate)(propName_1) === propName_1 && !propName_1.startsWith('data-') && !propName_1.startsWith('aria-') ? (0, shared_1.camelize)(propName_1)
                        : propName_1;
                ...
                const propName = (0, shared_1.hyphenate)(prop.name) === prop.name && !prop.name.startsWith('data-') && !prop.name.startsWith('aria-') ? (0, shared_1.camelize)(prop.name) : prop.name;
